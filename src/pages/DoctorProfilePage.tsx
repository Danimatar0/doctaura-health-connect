          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="lg:col-span-3">
              <CardHeader>
                ...
                <CardDescription>
                  Your professional credentials and specializations
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <p className="mt-1 text-base">{user.specialty || "Not provided"}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-muted-foreground">
                      Medical Certification
                    </label>
                    <p className="mt-1 text-base">{user.medicalCertification || "Not provided"}</p>
                  </div>
                </div>
                <Separator className="my-6" />
                <div className="text-center py-4 text-muted-foreground text-sm">
                  <p>Additional professional details will be loaded from the backend API in the future</p>
                </div>
              </CardContent>
            </Card>
          </div>
